#!/usr/bin/env python3
"""
Cold Calling Assistant - Streamlit App (Python 3.13 Compatible)
...
def search_businesses_sync(google_api_key: str, location: str, business_type: str, radius: int = 3000):
    """Synchronous wrapper for business search (Python 3.13 compatible)"""
    try:
        ...
        # Return basic business info (without async enrichment for Python 3.13 compatibility)
        return businesses
    ...
    if st.button("🔍 Search Businesses", type="primary"):
        ...
        with st.spinner(f"Searching for {business_type} businesses near {location}..."):
            if demo_mode:
                ...
                # Run synchronous search (Python 3.13 compatible)
